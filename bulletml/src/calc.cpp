...
static const char yytranslate[] = {
    0, 2, 2, 2, 2, 2, 2, 2, 2, 2, 13, 2, 2, 2, 2, 2, 2,  2,  2, 2, 2, 2, 2,  2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,  2, 2, 2, 2, 2, 14, 15, 9, 8, 2, 7, 2,  10,
    ...
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,  2, 2, 2, 2, 2, 2,  2,  2, 2, 2, 2, 2,  2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,  2, 2, 2, 2, 2, 2,  2,  2, 2, 2, 2, 2,  2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,  2, 2, 2, 2, 2, 1,  3,  4, 5, 6, 11};

#if YYDEBUG != 0
static const short yyprhs[] = {0,  0,  1,  4,  6,  9,  11, 13,
                               15, 17, 21, 25, 29, 33, 36};

static const short yyrhs[] = {
    -1, 16, 17, 0,  13, 0,  18, 13, 0, 3,  0,  4,  0, 5, 0,  6, 0,  18, 8,  18,
    0,  18, 7,  18, 0,  18, 9,  18, 0, 18, 10, 18, 0, 7, 18, 0, 14, 18, 15, 0};

#endif

#if YYDEBUG != 0
static const short yyrline[] = {0,  51, 52, 55, 56, 59, 63, 67,
...
static const char *const yytname[] = {
    "$",   "error", "$undefined.", "NUM",  "RAND", "RANK", "PARAM",
    "'-'", "'+'",   "'*'",         "'/'",  "NEG",  "'^'",  "'\\n'",
    "'('", "')'",   "input",       "line", "exp",  NULL};
#endif

static const short yyr1[] = {0,  16, 16, 17, 17, 18, 18, 18,
                             18, 18, 18, 18, 18, 18, 18};

static const short yyr2[] = {0, 0, 2, 1, 2, 1, 1, 1, 1, 3, 3, 3, 3, 2, 3};

static const short yydefact[] = {1, 0, 5, 6, 7, 8,  0,  3, 0,  2,  0, 13, 0,
                                 0, 0, 0, 0, 4, 14, 10, 9, 11, 12, 0, 0};

static const short yydefgoto[] = {1, 9, 10};

static const short yypact[] = {
    -32768, 0,  -32768, -32768, -32768, -32768, 5,     -32768, 5,
    -32768, 23, -32768, 19,     5,      5,      5,     5,      -32768,
    -32768, -8, -8,     -32768, -32768, 16,     -32768};

static const short yypgoto[] = {-32768, -32768, 9};

#define YYLAST 36

static const short yytable[] = {
    23, 15, 16, 2,  3,  4,  5,  6,  2,  3,  4,  5,  6,  7,  8,  11, 24, 12, 0,
    8,  0,  0,  19, 20, 21, 22, 13, 14, 15, 16, 13, 14, 15, 16, 18, 0,  17};

static const short yycheck[] = {
    0,  9,  10, 3,  4,  5,  6,  7, 3, 4, 5,  6, 7, 13, 14, 6,  0,  8, -1,
    14, -1, -1, 13, 14, 15, 16, 7, 8, 9, 10, 7, 8, 9,  10, 15, -1, 13};
